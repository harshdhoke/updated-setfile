...
const CreateProject = () => {
  ...
  const mv4Groups = [
    "//$MV4[MCLK:[*MCLK*], mipi_phy_type:[*PHY_TYPE*], mipi_lane:[*PHY_LANE*], mipi_datarate:[*MIPI DATA RATE*]]",
    ...
    "//$MV4_InterleavedData[isUsed:[*ILD_IS_USED_1*], width:[*ILD_WIDTH_1*], height:[*ILD_HEIGHT_1*], data_type:MIPI_RAW10 (0x2B), virtual_channel:[*ILD1_VC*]]",
    "//$MV4_InterleavedData[isUsed:[*ILD_IS_USED_2*], width:[*ILD_WIDTH_2*], height:[*ILD_HEIGHT_2*], data_type:MIPI_RAW10 (0x2B), virtual_channel:[*ILD2_VC*]]",
  ...
  const mv6Groups = [
    "//$MV6[MCLK:[*MCLK*], mipi_phy_type:[*PHY_TYPE*], mipi_lane:[*PHY_LANE*], mipi_datarate:[*MIPI DATA RATE*]]",
    ...
    "//$MV6_InterleavedData[isUsed:[*ILD_IS_USED_1*], width:[*ILD_WIDTH_1*], height:[*ILD_HEIGHT_1*], data_type:MIPI_RAW10 (0x2B), virtual_channel:[*ILD1_VC*]]",
    "//$MV6_InterleavedData[isUsed:[*ILD_IS_USED_2*], width:[*ILD_WIDTH_2*], height:[*ILD_HEIGHT_2*], data_type:MIPI_RAW10 (0x2B), virtual_channel:[*ILD2_VC*]]",
